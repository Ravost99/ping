...
def ping(round:int):
  version_update()
  clear()
  messages = ['Quick fetch coming soon!', 'Ravost99 is owner!', f'The world will end in █████', 'Currently Debugging!', f'Latest commit at: {last_commit}', f'1 = {str(round - 1)}', f'{str(random.randint(0, 1000000000))}', '- - - >']
  #ping rounds
  if config.ping_rounds == True:
